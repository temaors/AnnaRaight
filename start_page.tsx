...
export default function StartPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header with Logo */}
      <div className="flex justify-center md:justify-start px-8 pt-6 mb-8 md:mb-4">
      ...
      <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="-mt-4 lg:-mt-14">
              <LeadCaptureForm
                ...
                onSuccess={(email, firstName) => {
                  ...
                  router.push(`/video?firstName=${encodeURIComponent(firstName)}&email=${encodeURIComponent(email)}`);
                }}
              />
            </div>
        ...
        <div className="text-center mb-8">
          <div className="flex justify-center items-center space-x-4 md:space-x-8 flex-wrap">
            ...
            <img src="/photo1.png" alt="2021 Персона Года" className="h-16 md:h-20 object-contain" />
            <img src="/photo2.png" alt="Bomond" className="h-16 md:h-20 object-contain" />
          </div>
        </div>
      </div>
